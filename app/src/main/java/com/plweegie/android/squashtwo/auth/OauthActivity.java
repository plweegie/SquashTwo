/*
Copyright (c) 2016 Hardik Goswami
Modifications (c) 2017 Jan K Szymanski
 */

package com.plweegie.android.squashtwo.auth;
...
public class OauthActivity extends AppCompatActivity {
    ...
    private void storeToSharedPreference(String auth_token) {
        ...
        edit.putString(AuthUtils.PREFERENCE_NAME, auth_token);
        edit.apply();
    }
